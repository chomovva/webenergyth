...
add_action( 'template_redirect', 'webenergyth\single_result_redirect' );
...
add_filter( 'the_content', 'webenergyth\search_backlight' );

add_filter( 'get_the_excerpt', 'webenergyth\search_backlight' );

add_filter( 'the_title', 'webenergyth\search_backlight' );
...
add_filter( 'the_permalink', 'webenergyth\add_search_key_for_backlight', 10, 2 );